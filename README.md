...
- **Elu Functions Tools**, draggable quick-toggle buttons for a temporary portal-safety bypass and the client's Default Player Appearances option, handy for RvR performance.
